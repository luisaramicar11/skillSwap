...
export const FooterAdmin: React.FC = () => {
  return (
    <FooterStyled>
      <ul>
        <FooterNavItem onClick={() => handlePageTheme('INICIO')}>
          <StyledNavLink href="/admin" label="INICIO" />
        </FooterNavItem>
        <FooterNavItem onClick={() => handlePageTheme('USUARIOS')}>
          <StyledNavLink href="/admin/users" label="USUARIOS" />
        </FooterNavItem>
        <FooterNavItem onClick={() => handlePageTheme('REPORTES')}>
          <StyledNavLink href="/admin/reports" label="REPORTES" />
        </FooterNavItem>
        <FooterNavItem onClick={() => handlePageTheme('ADMIN/POSTS')}>
          <StyledNavLink href="/admin/posts" label="POSTS" />
        </FooterNavItem>
        <FooterNavItem onClick={() => handlePageTheme('LEGAL')}>
