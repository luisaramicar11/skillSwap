              ...
              <WidgetContainer>
                ...
                <DivDeactivateAccount>
                  ...
                  <div>
                    ...
                    <p><strong> Atención: </strong>Al desactivar tu cuenta tu información permanecerá segura y no será eliminada. Si decides reactivarla en el futuro, contacta a nuestro equipo de soporte.</p>
                  </div>
                </DivDeactivateAccount>
              </WidgetContainer>
            </PageBody>
